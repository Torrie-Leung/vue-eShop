  ...
  <div>
    ...
    <el-card>
      <el-table :data="rightsList" border stripe>
        ...
        <el-table-column label="Access Level" prop="level">
          <template v-slot="slotLevel">
            <el-tag v-if="slotLevel.row.level === '0'">Level-1</el-tag>
            <el-tag type="success" v-else-if="slotLevel.row.level === '1'">Level-2</el-tag>
            <el-tag type="warning" v-else-if="slotLevel.row.level === '2'">Level-3</el-tag>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
